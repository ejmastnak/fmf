...
\begin{itemize}
	...
	\begin{equation*}
		\curl \E = - \pdv{\B}{t} \eqtext{and} \curl \B = \mm \vec{j} + \e\mm \pdv{\E}{t}
	\end{equation*}
	and
	\begin{equation*}
...
\begin{itemize}
	...
	\begin{equation*}
		w = \frac{1}{2}\e E_{U2} + \frac{1}{2\mm}B^{2}
	\end{equation*}
...
\begin{itemize}
	...
	\begin{equation*}
		Q = \e E \cdot 2\pi r l \implies E = \frac{Q}{2\pi \e l r}
	\end{equation*}
	We find induced charge $ Q $ from potential via
	\begin{equation*}
		U = \int_{a}^{b} E \diff r = \frac{Q}{2\pi \e l}\ln \frac{b}{a}
	\end{equation*}
...
\begin{itemize}
	...
	\begin{equation*}
		E = \frac{\sigma}{\e} = \frac{q}{\e S} = \frac{I}{\e S}t
	\end{equation*}
	...
	\begin{equation*}
		\oint \B \cdot \diff \vec{l}  = \e \mm \pdv{\E}{t} \cdot (\pi r^{2})
	\end{equation*}
	Evaluate left-hand integral and substitute in electric field to get
	\begin{equation*}
		B \cdot (2\pi r) = \e \mm \frac{I}{\e S} \pi r^{2} \implies B = \frac{\mm I}{2S} r
	\end{equation*}
	...
	\begin{equation*}
		P = \int \S \cdot \diff \vec{S} = \int \SS \diff S = \frac{1}{\mm}\int EB \diff S = \frac{1}{\mm} \int  \left(\frac{I}{\e S}t\right)\left(\frac{\mm I}{2S} r\right) \diff S
	\end{equation*}
	...
	\begin{equation*}
		P = \frac{I^{2}a}{2\e S^{2}}t (2\pi a d) = \frac{I^{2}d}{\e S} t
	\end{equation*}
	...
	\begin{equation*}
		W_{\text{E}} = w_{\text{E}}V = \left(\frac{1}{2}\e E^{2}\right) \cdot \left(Sd\right) = \frac{\e}{2}\frac{I^{2}}{\e^{2}S^{2}}Sdt^{2} = \frac{I^{2}d}{2\e S}t^{2}
	\end{equation*}
	We then have
	\begin{equation*}
		\pdv{W}{t} = \pdv{W_{\text{E}}}{t} = \frac{I^{2}d}{\e S} t
	\end{equation*}
