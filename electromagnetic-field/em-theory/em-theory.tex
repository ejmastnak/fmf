...
\subsection{Eleventh Lecture}

\subsubsection{Electric Field in Matter}
...
\subsubsection{TODO: Constitutive Relation for Electric Field}
Looks like 45 minutes are missing from the lecture recording containing this material.
...
\subsubsection{The Constitive Relation for Magnetic Field in Materials}
\begin{itemize}
	...
	\begin{equation*}
		\H = \frac{\B}{\mm} + \chi_{\text{M}} \H = \frac{\B}{\mm} + (\mu - 1)\H.
	\end{equation*}
...
\subsubsection{Electric Field Energy in Material}
\begin{itemize}
	...
	\begin{align*}
		W - W_{0}  &= \frac{1}{2}\int_{V}(\E \cdot \D_{0} - \E_{0}\cdot\D)\dr\\
		& = - \frac{1}{2}\int_{V} \ee(\epsilon - 1)\E_{0}\E \dr\\
		& = -\frac{1}{2}\int_{V}\P \cdot \E_{0}\dr,
	\end{align*}
...
\subsubsection{Magnetic Field Energy in Material}
\begin{itemize}
...
\begin{itemize}
	...
	\begin{equation*}
		\vec{F}_{\text{E}} = - \frac{1}{2}\int_{V}(\grad \e(\r))\ee E^{2}\dr.
	\end{equation*}
