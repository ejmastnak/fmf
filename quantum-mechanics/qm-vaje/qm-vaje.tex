...
%	\item The result is that spin points in the opposite direction of the final field. The particle is still in the fundamental state of the final Hamiltonian. The particle remains in the \Ham's ground state.

% Note that $ \alpha $ encodes the energy gap between the ground and first excited state energy. This is why for small $ \alpha $ we stay in the ground state, because energy gap is large?
\end{itemize}
