...
\begin{itemize}
	...
	\item Because $ [\P, \vec{L}] = 0 $, the $ \P $ and $ \vec{L} $ share mutual eigenfunctions, meaning the spherical harmonics, which are nominally eigenfunctions of $ \vec{L} $, are also eigenfunctions of $ P $. 
...
\begin{itemize}
	...
	\end{equation*}
%	The energy eigenvalue $ \lambda_{3} $ and $ \lambda_{4} $ decrease and increase linearly with $ \E $, respectively, while the energy eigenvalues $ \lambda_{1} $ and $ \lambda_{2} $ have degeneracy 2.
...
\textbf{Quick Summary}: 
\begin{itemize}
	\item In the presence of the Coulomb-potential Hamiltonian
	\begin{equation*}
