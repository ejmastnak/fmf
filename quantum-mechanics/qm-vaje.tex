...
\begin{equation*}
	H = \frac{p_{1}^{2}}{2m} - \frac{\lambda}{\hbar^{2}}\delta(x)\vec{S}_{1}\cdot \vec{S}_{2}
\end{equation*}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item The other possible basis is the good quantum number basis, which works in terms of the total spin operator $ \vec{S} = \vec{S}_{1} + \vec{S}_{2} $. This basis uses commutativity of $ S^{2} $, $ S_{z} $, $ S_{1}^{2} $, and $ S_{2}^{2} $.
