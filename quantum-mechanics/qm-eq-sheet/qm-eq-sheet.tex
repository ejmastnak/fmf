...
$ \vec{S} \cdot \uvec{e} \ket{\psi_{s}} = \frac{\hbar}{2}\ket{\psi_{s}} $ implies $ \vec{S} \parallel \uvec{e} $ where\\
\null \quad $ \uvec{e} = (\cos \varphi \sin \theta, \sin \varphi \sin \theta, \cos \theta) $  \\
...
\newsec{Time Reversal}
$ 	\braket{\mathcal{T}\psi_{1}}{\mathcal{T}\psi_{2}} = \braket{\psi_{1}}{\psi_{2}}^{*} $\\
