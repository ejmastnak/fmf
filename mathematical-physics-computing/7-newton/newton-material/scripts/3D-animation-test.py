# The content of this script comes from the excellent tutorial from the below link:
...
def main(data, save=False):
    ...
    Args:
        data (np.ndarray): List of the data positions at each iteration.
...
sim_data = generate_data(50, 2)
sim_data = np.array(sim_data)
print(sim_data)
print(np.shape(sim_data))
main(sim_data, save=True)